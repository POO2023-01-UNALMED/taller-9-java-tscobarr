...
public class Calculator extends VBox implements EventHandler<ActionEvent> {
	...
	private void numeroIngresado(String value) {
	    if (operator == null) {
	        number1 += value;
	    } else {
	        number2 += value;
	...
	private void operadorIngresado(String value) {
	...
	private void actualizarPantalla() {
	    String displayTextValue = number1;

	    if (operator != null) {
	        displayTextValue += " " + operator + " " + number2;
	    }
